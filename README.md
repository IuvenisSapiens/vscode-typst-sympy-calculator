...
It is designed for providing **people writing in typst** a ability to calculate something when writing math expression. It is based on `Python`, `Sympy` and [`typst-sympy-calculator`](https://github.com/IuvenisSapiens/typst-sympy-calculator) module.
...
Then import the typst template file [`typst-sympy-calculator.typ`](https://github.com/IuvenisSapiens/typst-sympy-calculator.typ) into your typst file. It will be like:
